...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        double monthsPassed = LocalDate.now().getMonthValue();
        ...
        /*f*/
        double argumentLatitude = 160.7108 + 390.67050284 * k - 0.0016118 * Math.pow(t, 2) - 0.00000227 * Math.pow(t, 3) + 0.000000011 * Math.pow(t, 4) - 0.026665 * Math.sin(Math.toRadians(astronomicalLongitude));
        ...
        double a = 0.0003 * Math.sin(Math.toRadians(299.77 + 0.107408 * k - 0.009173 * Math.pow(t, 2)));
        double c = calculateCorrections(sunMeanAnomaly, );
        ...
        double p1 = 0.2070 * eValue * Math.sin(Math.toRadians(sunMeanAnomaly));
        double p2 = 0.0024 * eValue * Math.sin(Math.toRadians(2 * sunMeanAnomaly));
        double p3 = -0.0392 * Math.sin(Math.toRadians(moonMeanAnomaly));
        double p4 = 0.0116 * Math.sin(Math.toRadians(2 * moonMeanAnomaly));
        double p5 = -0.0073 * eValue * Math.sin(Math.toRadians(moonMeanAnomaly + sunMeanAnomaly));
        double p6 = 0.0067 * eValue * Math.sin(Math.toRadians(moonMeanAnomaly - sunMeanAnomaly));
        double p7 = 0.0118 * Math.sin(Math.toRadians(2 * argumentLatitude));
        double p = p1 + p2 + p3 + p4 + p5 + p6 + p7;
        double q1 = -0.0048 * eValue * Math.cos(Math.toRadians(sunMeanAnomaly));
        double q2 = 0.0020 * eValue * Math.cos(Math.toRadians(2 * sunMeanAnomaly));
        ...
        double u1 = 0.0046 * eValue * Math.cos(Math.toRadians(sunMeanAnomaly));
        double u2 = -0.0182 * Math.cos(Math.toRadians(moonMeanAnomaly));
        double u3 = 0.0004 * Math.cos(Math.toRadians(2 * moonMeanAnomaly));
        double u4 = -0.0005 * Math.cos(Math.toRadians(sunMeanAnomaly + moonMeanAnomaly));
        double u = 0.0059 + u1 + u2 + u3 + u4;
        double w = Math.abs(Math.cos(Math.toRadians(173.033505)));
        double y = (p * Math.cos(Math.toRadians(argumentLatitude)) + q * Math.sin(Math.toRadians(argumentLatitude)) * (1 - 0.0048 * w));
        double h = 1.5573 + u;
        ...
        double magnitude = calculateMagnitude(h, pValue, Math.abs(tValue));
    ...
    public static double calculateCorrections(double k, double t) {
        ...
        double C5 = 0.0073 * E * Math.sin(Math.toRadians(M - omega));
        double C6 = -0.0050 * E * Math.sin(Math.toRadians(M + omega));
        ...
        double C10 = 0.0006 * E * Math.sin(Math.toRadians(2 * M + omega));
        ...
        double C14 = -0.0002 * E * Math.sin(Math.toRadians(2 * M - omega));
    ...
    public static double calculateMagnitude(double h, double pValue, double tValue) {
        return h * pValue * Math.abs(tValue);
    }
